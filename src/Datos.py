        ...
        if opcion == "1":
            ...
            for dispositivo in dispositivos:
                if dispositivo["Nombre"].lower() == nombre_producto.lower():
                    ...
                    for key, value in dispositivo.items(): #Realizo un for para entrar a cada clave del dispositivo y poder buscar por nombre el producto e imprimir los detalles
                        print(f"{key}: {value}")  
                    break
            else:
            ...
            for dispositivo in dispositivos:
                if dispositivo["Nombre"].lower() == nombre_producto.lower():
                    ...
                    for key, value in dispositivo.items():
                        print(f"{key}: {value}") #Realizo un for para entrar a cada clave del dispositivo y poder buscar por nombre el producto e imprimir los detalles
                    break
            else:
                print("Producto no encontrado.")
